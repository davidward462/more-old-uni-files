...
class SL_Board:
	...
	def __init__(self, width, snakes, ladders):
		...
		#  Ladder tops: a list: ["L#B" where # is an integer, location of the top]
		#  Ladder bottoms: a list: "L#T" where # is an integer
		ladder_count = 1
	...
	# is_snake - accessor method - Check if the square is the tail of a snake
	# returns true if the square is the tail of a snake
...
#	game = SL_Board(5, [(15,2), (24,13)], [(4, 12),(19,21),(7,20)] )
#	print(game)
